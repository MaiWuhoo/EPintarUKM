...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-md">
        <h2 class="text-2xl font-bold text-center mb-6">Tukar Kata Laluan</h2>
        <form action="../controllers/prosesreset.php" method="POST" class="space-y-4">
            <div>
                <label class="block text-gray-700">Kata Laluan Baharu</label>
                <input type="password" name="new_password" placeholder="Kata Laluan Baharu"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-400"
                    required>
            </div>
            <div>
                <label class="block text-gray-700">Sahkan Kata Laluan</label>
